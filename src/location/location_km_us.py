...
loc_class_out = base_path+'/Dataset/ws/localinfo/ws_local_classif_out.txt';

loc_class_for_user = base_path+'/Dataset/ws/localinfo/ws_local_classif_out_by_user.txt';
